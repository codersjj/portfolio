...
const MemoriesCardsSection: React.FC<MemoriesCardsSectionProps> = ({ cardsRef }) => {
    ...
    useEffect(() => {
        ...
        mainTimeline
            ...
            .to(photo1Ref.current, {
                x: 0,
                opacity: 1,
                rotateY: 0,
                duration: 0.9,
                ease: 'power2.out',
            }, '-=0.3') // 负延迟：在前一个动画结束前0.3秒就开始
            // Card 2
            .to(card2Ref.current, {
                x: 0,
                opacity: 1,
            ...
            <div className="md:col-span-1 flex flex-col gap-8">
                ...
                <div ref={card1Ref} className="blessing-card group relative">
                    ...
                    <div className="relative p-8 bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        {/* Card title */}
                        <h3 className={`text-3xl font-serif mb-3 text-transparent bg-clip-text bg-gradient-to-r ${BLESSING_CARDS[0].color} relative z-10 group-hover:scale-105 transition-transform duration-300`}>
            ...
            <div className="md:col-span-1 flex flex-col gap-8">
                ...
                <div ref={card2Ref} className="blessing-card group relative">
                    ...
                    <div className="relative p-8 bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        {/* Card title */}
                        <h3 className={`text-3xl font-serif mb-3 text-transparent bg-clip-text bg-gradient-to-r ${BLESSING_CARDS[1].color} relative z-10 group-hover:scale-105 transition-transform duration-300`}>
            ...
            <div className="md:col-span-1 flex flex-col gap-8">
                ...
                <div ref={card3Ref} className="blessing-card group relative">
                    ...
                    <div className="relative p-8 bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        {/* Card title */}
                        <h3 className={`text-3xl font-serif mb-3 text-transparent bg-clip-text bg-gradient-to-r ${BLESSING_CARDS[2].color} relative z-10 group-hover:scale-105 transition-transform duration-300`}>
