...
const BorderMagicButton = ({ title, icon, position = 'right', handleClick, className = '', otherClasses = '' }: {
  title: string;
  ...
  return (
    <button
      className={`relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none ${className}`}
      onClick={handleClick}
    >
